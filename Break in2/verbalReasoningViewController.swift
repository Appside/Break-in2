...
class verbalReasoningViewController: QuestionViewController, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let passageViewTop:NSLayoutConstraint = NSLayoutConstraint(item: self.passageView, attribute: NSLayoutAttribute.Top, relatedBy: NSLayoutRelation.Equal, toItem: self.mainView, attribute: NSLayoutAttribute.Top, multiplier: 1, constant: 100)
        ...
        if self.showTutorial == true {
            ...
            let tutoDescriptionCenterY:NSLayoutConstraint = NSLayoutConstraint(item: self.tutoDescription, attribute: NSLayoutAttribute.CenterY, relatedBy: NSLayoutRelation.Equal, toItem: self.tutoView, attribute: NSLayoutAttribute.CenterY, multiplier: 1, constant: 300/2-60)
            ...
            let tutoNextButtonBottom:NSLayoutConstraint = NSLayoutConstraint(item: self.tutoNextButton, attribute: NSLayoutAttribute.Bottom, relatedBy: NSLayoutRelation.Equal, toItem: self.tutoView, attribute: NSLayoutAttribute.Bottom, multiplier: 1, constant: -10)
            ...
            attributedString.addAttribute(NSFontAttributeName, value: UIFont(name: "HelveticaNeue-Medium", size: 25.0)!, range: NSRange(location: 7, length: NSString(string: labelString).length-7))
    ...
    func tutoNext(sender:UITapGestureRecognizer) {
        ...
        if self.tutoPage==2 {
            ...
            self.tutoDescriptionText.text = "A passage will appear with a question at the top of the screen. To answer it, swipe up the answer menu at the bottom of the screen and select an answer."
        }
        if self.tutoPage==3 {
