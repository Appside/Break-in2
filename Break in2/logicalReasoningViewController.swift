...
class logicalReasoningViewController: QuestionViewController, UIScrollViewDelegate {
    ...
    var logical:logicalShapes = logicalShapes()
    ...
    func displayQuestion(indexQuestion:Int) {
        ...
        let arrayAnswers:[logicalShapes] = self.quizzArray[indexQuestion].answers
        let questionAsked:[logicalShapes] = self.quizzArray[indexQuestion].question
    ...
    func fillArrayWithRandomNumbers() -> ([logicalShapes], [logicalShapes],Int, String) {
        
        //Set function's variables
        var questionArray:[logicalShapes] = [logicalShapes]()
        var answersArray:[logicalShapes] = [logicalShapes]()
        var returnedArray:[logicalShapes] = [logicalShapes]()
        ...
        for i=0;i<4;i++ {
            questionArray.append(logicalShapes())
            answersArray.append(logicalShapes())
        }
