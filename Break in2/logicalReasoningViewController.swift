...
class logicalReasoningViewController: QuestionViewController, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let topMenuViewWidth:NSLayoutConstraint = NSLayoutConstraint(item: self.menuBackButton, attribute: NSLayoutAttribute.Width, relatedBy: NSLayoutRelation.Equal, toItem: nil, attribute: NSLayoutAttribute.NotAnAttribute, multiplier: 1, constant: 75*self.heightRatio)
