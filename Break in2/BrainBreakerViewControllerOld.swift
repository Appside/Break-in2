...
class BrainBreakerViewControllerOld: QuestionViewController, UIScrollViewDelegate, GADInterstitialDelegate {
    ...
    let isFeedbackScreen:Bool = false
    ...
    override func viewDidLoad() {
        ...
        imageViewBackground.image = UIImage(named: "brainbreakerBG")
        ...
        swipeUpGesture = UITapGestureRecognizer.init(target: self, action: #selector(BrainBreakerViewControllerOld.SwipeMenu(_:)))
